    ...
    return(
        ...
        <div className="row">
          <div className="col">
            ...
            <div className="div_res" style={{ padding: '10px', marginTop: '5%', width: '70%' }} id="audiodiv">
              <br /><br />
                ...
                <table cellSpacing="0px" cellPadding="0px" width="100%" style={{ marginTop: '30px' }}>
                  <tbody>
                    <tr style={{ fontSize: '18px' }}>
                      <td width="30%">Uric Acid</td>
                      <td className="pink" style={{ textAlign: 'left' }} width="30%">
                        &nbsp;:&nbsp;1.0 mg/dl
                      </td>
                      <td style={{ textAlign: 'left' }} width="20%">
                        &nbsp;(Male 3.5-7.5 mg/dl)(Female 2.5-6.5 mg/dl)
                      </td>
                    </tr>
                  </tbody>
                </table>
